...
def postprocess(fileCSV, newFile, postprocess_config, verbose=False):
    ...
    Args:
        ...
        postprocess_config : configuration for postprocessing defined in config.yaml, see default values below to check which values must be provided
    """
    ...
    try : 
        ...
        if postprocess_config["lowpass_filter"]:
            ...
            sos = butter(order_lowpass_filter,lowpass_critical_frequency,fs=signal_frequency,output='sos')
